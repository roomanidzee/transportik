...
trait TransportAnalysisPreparator {
  ...
  implicit val analysisEncoder: Encoder[TransportAnalysisDomain] =
    (a: TransportAnalysisDomain) => Json.obj(
  ...
  implicit def analysisEntityEncoder[F[_]: Applicative]: EntityEncoder[F, TransportAnalysisDomain] = jsonEncoderOf
  implicit val analysisIOEncoder: EntityEncoder[IO, TransportAnalysisDomain] = jsonEncoderOf[IO, TransportAnalysisDomain]
