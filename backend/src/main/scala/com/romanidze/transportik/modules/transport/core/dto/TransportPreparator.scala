...
trait TransportPreparator {
  ...
  implicit def transportEntityEncoder[F[_]: Applicative]: EntityEncoder[F, TransportInfoEntity] =
    jsonEncoderOf
  implicit val transportIOEncoder: EntityEncoder[IO, TransportInfoEntity] =
    jsonEncoderOf[IO, TransportInfoEntity]
  ...
  implicit val transportIODecoder: EntityDecoder[IO, TransportInfoEntity] =
    jsonOf[IO, TransportInfoEntity]
