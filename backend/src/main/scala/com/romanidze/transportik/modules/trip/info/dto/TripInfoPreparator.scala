...
trait TripInfoPreparator {
  ...
  implicit def tripInfoEntityEncoder[F[_]: Applicative]: EntityEncoder[F, TripInfoEntity] =
    jsonEncoderOf
  implicit val tripInfoIOEncoder: EntityEncoder[IO, TripInfoEntity] =
    jsonEncoderOf[IO, TripInfoEntity]
...
object TripInfoPreparator extends TripInfoPreparator
