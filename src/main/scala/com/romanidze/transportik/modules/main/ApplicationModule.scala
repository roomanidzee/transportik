...
class ApplicationModule[F[_]: Concurrent: Async: ContextShift: FromGFuture](
  ...
  private val cassandraSession = initializer.prepareCassandraConfig(config.cassandra)
  ...
  private val transportModule = new TransportModule[F](transactor, cassandraSession)
